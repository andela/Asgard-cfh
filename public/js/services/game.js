  ...
  .factory('game', ['socket', '$timeout', function (socket, $timeout) { // eslint-disable-line
    ...
    var setNotification = function () { // eslint-disable-line
      if (notificationQueue.length === 0) { // If notificationQueue is empty, stop
        ...
        game.notification = notificationQueue.shift(); // eslint-disable-line 
        timeout = $timeout(setNotification, 1300);
      }
    };

    let addToNotificationQueue = function (msg) { // eslint-disable-line
    ...
    game.joinGame = function (mode, room, createPrivate) { // eslint-disable-line 
      ...
      let userID = window.user ? user._id : 'unauthenticated'; // eslint-disable-line 
